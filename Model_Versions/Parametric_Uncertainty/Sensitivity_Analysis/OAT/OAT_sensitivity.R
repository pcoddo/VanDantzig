...
matplot(quantile_prior, (costs_OAT/1e+06), type = 'l', lty = 1, lwd = 2, 
        col = c("dark gray", "dark gray", "dark gray", "dark gray", OAT_col[5], "dark gray","dark gray"),
...
legend("topleft",
       c("p_zero_p", "alpha_p", "V_p", "delta_prime_p", "k_p", "subs_rate", "sea_level_rate"),
       pch = 22, 
       bty = 'n',
       pt.bg = c("light gray", "light gray", "light gray", "light gray", OAT_col[5], "light gray", "light gray"),
       col = c("dark gray", "dark gray", "dark gray", "dark gray", "black", "dark gray", "dark gray"),
       text.col = c("dark gray", "dark gray", "dark gray", "dark gray", "black", "dark gray", "dark gray"),
       cex = 1,
       pt.cex = 1.5,
       inset = c(0.01, -0.02))

matplot(quantile_prior, (NPV_expected_losses_OAT/1e+06), type = 'l', lty = 1, lwd = 2, 
        col = c(OAT_col[1:4], "dark gray", OAT_col[6:7]),
        xlab = "Quantile of prior (%)",
        ylab = "Costs (million Guilders)",
        xaxt='n',
        las = 0)
...
legend("topleft",
       ...
       pch = 22, 
       bty = 'n',
       pt.bg = c(OAT_col[1:4], "light gray", OAT_col[6:7]),
       col = c("black", "black", "black", "black", "dark gray", "black", "black"),
       text.col = c("black", "black", "black", "black", "dark gray", "black", "black"),
       cex = 1,
       pt.cex = 1.5,
       inset = c(0.01, -0.02))

matplot(quantile_prior, (EV_p_exceed_transient_OAT), type = 'l', lty = 1, lwd = 2, 
        col = c(OAT_col[1:2], "dark gray", "dark gray", "dark gray", OAT_col[6:7]),
        xlab = "Quantile of prior (%)",
...
legend("topleft",
       ...
       pch = 22, 
       bty = 'n',
       pt.bg = c(OAT_col[1:2], "light gray", "light gray", "light gray", OAT_col[6:7]),
       col = c("black", "black", "dark gray", "dark gray", "dark gray", "black", "black"),
       text.col = c("black", "black", "dark gray", "dark gray", "dark gray", "black", "black"),
       cex = 1,
       pt.cex = 1.5,
       inset = c(0.01, -0.02))
...
names(costs_range) <- names(priors)
names(NPV_expected_losses_range) <- names(priors)
names(EV_p_exceed_transient_range) <- names(priors)
names(total_costs_range) <- names(priors)
...
cost_col = c(OAT_col[5], "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray")
damages_col = c(OAT_col[1], OAT_col[2], OAT_col[7], OAT_col[4], OAT_col[3], OAT_col[6], "dark gray")
reliability_col = c(OAT_col[1], OAT_col[2], OAT_col[7], OAT_col[6], "dark gray", "dark gray", "dark gray")
total_cost_col = c(OAT_col[5], OAT_col[1], OAT_col[2], OAT_col[7], OAT_col[4], OAT_col[3], OAT_col[6])
...
axis(side = 1, at = seq(-1,1, by = 0.2), labels = seq(-100, 100, by = 20))
text(x = lab_text[,1], y = lab_text[,2], labels = c(expression(p[0], alpha, phi, delta~"'", "V", eta, "")))
abline(v = 0, lty = 2)
box(lwd = 1.5)
...
axis(side = 1, at = seq(-1,1, by = 0.2), labels = seq(-100, 100, by = 20))
text(x = lab_text[,1], y = lab_text[,2], labels = c(expression(p[0], alpha, phi, eta, "", "", "")))
abline(v = 0, lty = 2)
box(lwd = 1.5)
...
axis(side = 1, at = seq(-1,1, by = 0.2), labels = seq(-100, 100, by = 20))
text(x = lab_text[,1], y = lab_text[,2], labels = c(expression("k", p[0], alpha, phi, delta~"'", "V", eta)))
abline(v = 0, lty = 2)
box(lwd = 1.5)
