...
xi              = array(GEV_mode$xi.mode, length(quantile_prior))
mu              = array(GEV_mode$mu.mode, length(quantile_prior))
sigma           = array(GEV_mode$sigma.mode, length(quantile_prior))

Parameters <- data.frame(V_p, delta_prime_p, k_p, subs_rate, a, b, c, t.star, c.star, xi, mu, sigma)
...
# Objective plots
pdf(file = "Figures/OAT_Objectives3.pdf", width = 8, height = 8)
...
matplot(quantile_prior, (NPV_expected_losses_OAT/1e+06), type = 'l', lty = 1, lwd = 2, 
        col = c(OAT_col[1:2], "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", OAT_col[10:12]),
        xlab = "Quantile of prior (%)",
        ylab = "Costs (million Guilders)",
        xaxt='n',
        las = 0)
...
legend("topleft",
       ...
       pch = 22, 
       bty = 'n',
       pt.bg = c(OAT_col[1:2], "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", OAT_col[10:12]),
       col = c("black", "black", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "black", "black", "black"),
       text.col = c("black", "black", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "black", "black", "black"),
       cex = 1,
       pt.cex = 1.5,
       inset = c(0.01, -0.02))

matplot(quantile_prior, (EV_p_exceed_transient_OAT), type = 'l', lty = 1, lwd = 2, 
        col = c("light gray", "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", OAT_col[10:12]),
        xlab = "Quantile of prior (%)",
...
legend("topleft",
       ...
       pch = 22, 
       bty = 'n',
       pt.bg = c("light gray", "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", OAT_col[10:12]),
       col = c("dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "black", "black", "black"),
       text.col = c("dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "black", "black", "black"),
       cex = 1,
       pt.cex = 1.5,
       inset = c(0.01, -0.02))

matplot(quantile_prior, (total_costs_OAT/1e+06), type = 'l', lty = 1, lwd = 2, 
        col = c(OAT_col[1:3], "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", OAT_col[10:12]),
        xlab = "Quantile of prior (%)",
        ylab = "Costs (million Guilders)",
        xaxt='n',
        las = 0)
...
legend("topleft",
       ...
       pch = 22, 
       bty = 'n',
       pt.bg = c(OAT_col[1:3], "light gray", "light gray", "light gray", "light gray", "light gray", "light gray", OAT_col[10:12]),
       col = c("black", "black", "black", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "black", "black", "black"),
       text.col = c("black", "black", "black", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "black", "black", "black"),
       cex = 1,
       pt.cex = 1.5,
       inset = c(0.01, -0.02))
...
damages_col       = c(OAT_col[10], OAT_col[12], OAT_col[11], OAT_col[2], OAT_col[1], "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray")
reliability_col   = c(OAT_col[10], OAT_col[12], OAT_col[11], "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray")
total_cost_col    = c(OAT_col[10], OAT_col[12], OAT_col[3], OAT_col[11], OAT_col[2], OAT_col[1], "dark gray", "dark gray", "dark gray", "dark gray", "dark gray", "dark gray")

# Plot results
pdf("Figures/OAT_Tornado3.pdf", width = 8, height = 8)
par(oma = c(0,0,0,0)+0.1, mar = c(5,5,2,1)+0.1, mfrow = c(2,2))
...
axis(side = 1, at = seq(-1,1, by = 0.2), labels = seq(-100, 100, by = 20))
text(x = lab_text[,1], y = lab_text[,2], labels = c(expression(xi), expression(sigma), expression(mu), delta~"'", "V", "", "", "", "", "", "", ""))
abline(v = 0, lty = 2)
box(lwd = 1.5)
...
axis(side = 1, at = seq(-1,1, by = 0.2), labels = seq(-100, 100, by = 20))
text(x = lab_text[,1], y = lab_text[,2], labels = c(expression(xi), expression(sigma), expression(mu), "", "", "", "", "", "", "", "", ""))
abline(v = 0, lty = 2)
box(lwd = 1.5)
...
axis(side = 1, at = seq(-1,1, by = 0.2), labels = seq(-100, 100, by = 20))
text(x = lab_text[,1], y = lab_text[,2], labels = c(expression(xi), expression(sigma), "k", expression(mu), delta~"'", "V", "", "", "", "", "", ""))
abline(v = 0, lty = 2)
box(lwd = 1.5)
