...
param_desc <- c("Value of goods", "Effective discount rate", "Cost rate of heightening", "Subsidence rate", 
                ...
                "GEV location", "GEV scale", "GEV shape")
...
# Objective plots
pdf(file = "Figures/test2.pdf", width = 5.5, height = 8.5)
par(oma = c(4,3.75,0.5,0), mar = c(1,0,1,1.25)+0.1, mfcol = c(4,2))
layout(matrix(c(1:8), 4, 2, byrow = F), widths = c(2.3, 3.4), heights = c(rep(2.1, 4)))
...
abline(v = 0.5, lty = 2)
box(lwd = 1.3)
mtext("A. Discounted total costs", font = 1, side = 3, line = 0.25, at = -0.03, adj = c(0,0), cex = 0.90)
mtext("Costs (million Guilders)", font = 1, side = 2, line = 2.5, cex = 0.85)
...
abline(v = 0.5, lty = 2)
box(lwd = 1.3)
mtext("B. Reliability", font = 1, side = 3, line = 0.25, at = -0.03, adj = c(0,0), cex = 0.90)
mtext("Costs (million Guilders)", font = 1, side = 2, line = 2.5, cex = 0.85)
axis(side = 1, at = c(0.01, 0.25, 0.5, 0.75, 0.99), labels = FALSE, tck = -0.02)
...
abline(v = 0.5, lty = 2)
box(lwd = 1.3)
mtext("C. Investment costs", font = 1, side = 3, line = 0.25, at = -0.03, adj = c(0,0), cex = 0.90)
mtext("Costs (million Guilders)", font = 1, side = 2, line = 2.5, cex = 0.85)
axis(side = 1, at = c(0.01, 0.25, 0.5, 0.75, 0.99), labels = FALSE, tck = -0.02)
...
abline(v = 0.5, lty = 2)
box(lwd = 1.3)
mtext("D. Discounted damages", font = 1, side = 3, line = 0.25, at = -0.03, adj = c(0,0), cex = 0.90)
mtext("Costs (million Guilders)", font = 1, side = 2, line = 2.5, cex = 0.85)
...
text(x = 1.8, y = lab_text[,2], cex = 1, labels = total_cost_lab, adj = c(1,0.5), col = total_cost_col.3)
text(x = 1.95, y = lab_text[,2], cex = 1, labels = symbol_lab, adj = c(1,0.5), col = total_cost_col.3)
...
text(x = 1.8, y = lab_text[,2], cex = 1, labels = total_cost_lab, adj = c(1,0.5), col = reliability_col.3)
text(x = 1.95, y = lab_text[,2], cex = 1, labels = symbol_lab, adj = c(1,0.5), col = reliability_col.3)
axis(side = 1, at = seq(-1,1, by = 0.5), labels = FALSE, tck = -0.02)
segments(0, -2, 0, 1.1, lty = 2)
box(lwd = 1.3)
...
text(x = 1.8, y = lab_text[,2], cex = 1, labels = total_cost_lab, adj = c(1,0.5), col = cost_col.3)
text(x = 1.95, y = lab_text[,2], cex = 1, labels = symbol_lab, adj = c(1,0.5), col = cost_col.3)
axis(side = 1, at = seq(-1,1, by = 0.5), labels = FALSE, tck = -0.02)
segments(0, -2, 0, 1.1, lty = 2)
box(lwd = 1.3)
...
text(x = 1.8, y = lab_text[,2], cex = 1, labels = total_cost_lab, adj = c(1,0.5), col = damages_col.3)
text(x = 1.95, y = lab_text[,2], cex = 1, labels = symbol_lab, adj = c(1,0.5), col = damages_col.3)
