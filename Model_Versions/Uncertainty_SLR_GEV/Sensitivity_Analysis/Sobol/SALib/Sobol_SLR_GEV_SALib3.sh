...
#PBS -j oe
#PBS -o Sobol_SALib_SLR_GEV3.txt
#PBS -m abe
#PBS -M poddo@psu.edu
...
MODEL_EXE="Sobol_SLR_GEV_SALib3.R"       # name of the executable
...
Rscript ./Parameters/params_transform.R
...
OBJ_NAMES=("total_costs" "costs" "damages" "reliability") # Create vector of objective names
for N in $(seq 1 4)
do
