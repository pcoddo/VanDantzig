...
#mu = 284.7006 ; sigma = 44.06837; xi = -0.03178704
...
abline(v = (284.93945299),col="blue",lwd=2,lty="dashed")
...
abline(v = (44.22949852),col="blue",lwd=2,lty="dashed")
...
abline(v = (-0.03288799),col="blue",lwd=2,lty="dashed")
...
parmat<-rbind(MLE=c(284.93945299,44.22949852,-0.03288799),parmat)
dimnames(parmat)<-list(c("MLE","5%","16%","Best Guess","84%","95%"),c("mu","sigma","xi"))

parmat

rl_mat<-cbind(year=(1:76),
      rl_MLE=benreturn((1.01:76.01),284.93945299,44.22949852,-0.03288799),
      rl_5=benreturn((1.01:76.01),parmat[2,1],parmat[2,2],parmat[2,3]),
      rl_16=benreturn((1.01:76.01),parmat[3,1],parmat[3,2],parmat[3,3]),
      rl_Best_Guess=benreturn((1.01:76.01),parmat[4,1],parmat[4,2],parmat[4,3]),
      rl_84=benreturn((1.01:76.01),parmat[5,1],parmat[5,2],parmat[5,3]),
      rl_95=benreturn((1.01:76.01),parmat[6,1],parmat[6,2],parmat[6,3]))
